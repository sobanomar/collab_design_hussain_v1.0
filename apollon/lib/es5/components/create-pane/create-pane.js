...
var uml_sequence_diagram_preview_1 = require("../../packages/uml-sequence-diagram/uml-sequence-diagram-preview");
var getInitialState = function (_a) {
    ...
    switch (type) {
        ...
        case diagram_type_1.UMLDiagramType.BPMN:
            ...
            break;
        case diagram_type_1.UMLDiagramType.SequenceDiagram:
            previews.push.apply(previews, tslib_1.__spreadArray([], tslib_1.__read((0, uml_sequence_diagram_preview_1.composeSequenceDiagramPreview)(canvas, translate)), false));
            break;
    }
    if (colorEnabled) {
...
var CreatePaneComponent = /** @class */ (function (_super) {
    ...
    CreatePaneComponent.prototype.render = function () {
        ...
        return (react_1.default.createElement(model_store_1.StoreProvider, { initialState: { elements: elements, editor: { features: features } } },
            react_1.default.createElement("div", { style: { display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 8 } }, this.getElementArray(previews)),
