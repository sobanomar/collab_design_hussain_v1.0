...
var SidebarComponent = /** @class */ (function (_super) {
    ...
    SidebarComponent.prototype.render = function () {
        if (this.props.readonly || this.props.mode === editor_types_1.ApollonMode.Assessment)
            return null;
        return (react_1.default.createElement(sidebar_styles_1.Container, { id: "modeling-editor-sidebar", "data-cy": "modeling-editor-sidebar" }, this.props.view === "Modelling" /* ApollonView.Modelling */ ? (react_1.default.createElement(create_pane_1.CreatePane, null)) : (react_1.default.createElement("label", { htmlFor: "toggleInteractiveElementsMode" },
