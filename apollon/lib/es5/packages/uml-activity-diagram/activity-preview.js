...
var uml_activity_swimlane_1 = require("./uml-activity-swimlane/uml-activity-swimlane");
var composeActivityPreview = function (layer, translate) {
    ...
    // Activity Swimlane
    var activitySwimlane = new uml_activity_swimlane_1.UMLActivitySwimlane({ name: 'Swimlane' });
    activitySwimlane.bounds = tslib_1.__assign(tslib_1.__assign({}, activitySwimlane.bounds), { width: 150, height: 300 });
    elements.push(activitySwimlane);
    return elements;
};
