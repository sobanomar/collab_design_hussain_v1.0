...
exports.UMLComponentSubsystemUpdate = void 0;
...
var stereotype_toggle_1 = require("../../../components/controls/stereotype-toggle/stereotype-toggle");
var Flex = styles_1.styled.div(templateObject_1 || (templateObject_1 = tslib_1.__makeTemplateObject(["\n  display: flex;\n  align-items: baseline;\n  justify-content: space-between;\n"], ["\n  display: flex;\n  align-items: baseline;\n  justify-content: space-between;\n"])));
var ComponentSubsystemUpdate = /** @class */ (function (_super) {
    tslib_1.__extends(ComponentSubsystemUpdate, _super);
    function ComponentSubsystemUpdate() {
        ...
        _this.onStereotypeVisibilityToggle = function () {
            var _a = _this.props, element = _a.element, update = _a.update;
            var newVisibilityValue = !element.displayStereotype;
            update(element.id, { displayStereotype: newVisibilityValue });
        };
        return _this;
    }
    ComponentSubsystemUpdate.prototype.render = function () {
        var _this = this;
        ...
        return (react_1.default.createElement("div", null,
            react_1.default.createElement("section", null,
                react_1.default.createElement(Flex, null,
                    ...
                    react_1.default.createElement(stereotype_toggle_1.StereotypeToggle, { value: element.displayStereotype, onChange: this.onStereotypeVisibilityToggle }),
    ...
    return ComponentSubsystemUpdate;
}(react_1.Component));
...
exports.UMLComponentSubsystemUpdate = enhance(ComponentSubsystemUpdate);
