...
import { SequenceLifelineComponent } from './uml-sequence-diagram/uml-sequence-lifeline/uml-sequence-lifeline-component';
import { SequenceFragmentComponent } from './uml-sequence-diagram/uml-sequence-fragment/uml-sequence-fragment-component';
import { SequenceActivationComponent } from './uml-sequence-diagram/uml-sequence-activation/uml-sequence-activation-component';
import { UMLSequenceActorComponent } from './uml-sequence-diagram/uml-sequence-actor/uml-sequence-actor-component';
import { UMLSequenceExitComponent } from './uml-sequence-diagram/uml-sequence-exit/uml-sequence-exit-component';
import { UMLActivitySwimlaneComponent } from './uml-activity-diagram/uml-activity-swimlane/uml-activity-swimlane-component';
export const Components = {
    ...
    [UMLElementType.SequenceLifeline]: SequenceLifelineComponent,
    [UMLElementType.SequenceActivation]: SequenceActivationComponent,
    [UMLElementType.SequenceFragment]: SequenceFragmentComponent,
    [UMLElementType.SequenceActor]: UMLSequenceActorComponent,
    [UMLElementType.SequenceExit]: UMLSequenceExitComponent,
    [UMLElementType.ActivitySwimlane]: UMLActivitySwimlaneComponent,
