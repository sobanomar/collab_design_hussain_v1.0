...
import { UMLActivitySwimlane } from './uml-activity-swimlane/uml-activity-swimlane';
export const composeActivityPreview = (layer, translate) => {
    ...
    // Activity Swimlane
    const activitySwimlane = new UMLActivitySwimlane({ name: 'Swimlane' });
    activitySwimlane.bounds = {
        ...activitySwimlane.bounds,
        width: 150,
        height: 300,
    };
