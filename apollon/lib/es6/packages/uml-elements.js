...
import { SequenceLifeline } from './uml-sequence-diagram/uml-sequence-lifeline/uml-sequence-lifeline';
import { SequenceActivation } from './uml-sequence-diagram/uml-sequence-activation/uml-sequence-activation';
import { SequenceFragment } from './uml-sequence-diagram/uml-sequence-fragment/uml-sequence-fragment';
import { UMLSequenceActor } from './uml-sequence-diagram/uml-sequence-actor/uml-sequence-actor';
import { UMLSequenceExit } from './uml-sequence-diagram/uml-sequence-exit/uml-sequence-exit';
import { UMLActivitySwimlane } from './uml-activity-diagram/uml-activity-swimlane/uml-activity-swimlane';
export const UMLElements = {
    ...
    [UMLElementType.SequenceLifeline]: SequenceLifeline,
    [UMLElementType.SequenceActivation]: SequenceActivation,
    [UMLElementType.SequenceFragment]: SequenceFragment,
    [UMLElementType.SequenceActor]: UMLSequenceActor,
    [UMLElementType.SequenceExit]: UMLSequenceExit,
    [UMLElementType.ActivitySwimlane]: UMLActivitySwimlane,
};
