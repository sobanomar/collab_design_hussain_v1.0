...
export const Popups = {
    ...
    [UMLElementType.SequenceLifeline]: DefaultPopup,
    [UMLElementType.SequenceActivation]: DefaultPopup,
    [UMLElementType.SequenceFragment]: DefaultPopup,
    [UMLElementType.SequenceActor]: DefaultPopup,
    [UMLElementType.SequenceExit]: null,
    [UMLElementType.ActivitySwimlane]: DefaultPopup,
    // Relationships
