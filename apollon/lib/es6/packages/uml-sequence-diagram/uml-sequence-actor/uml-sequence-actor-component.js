...
export const UMLSequenceActorComponent = ({ element, fillColor }) => (React.createElement("g", null,
    React.createElement("rect", { width: "100%", height: "100%", fill: "none" }),
    React.createElement(Text, { fill: element.textColor, x: computeDimension(1.0, 40), y: computeDimension(1.0, -10) }, element.name),
    React.createElement("g", { stroke: element.strokeColor || 'black', strokeWidth: 2 },
        ...
        React.createElement(ThemedLine, { x1: computeDimension(1.0, 40), y1: computeDimension(1.0, 110), x2: computeDimension(1.0, 40), y2: element.bounds.height, strokeColor: element.fillColor, strokeDasharray: "5,5" }))));
