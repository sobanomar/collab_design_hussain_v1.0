...
import { composeSequenceDiagramPreview } from '../../packages/uml-sequence-diagram/uml-sequence-diagram-preview';
const getInitialState = ({ type, canvas, translate, colorEnabled }) => {
    ...
    switch (type) {
        ...
        case UMLDiagramType.SequenceDiagram:
            previews.push(...composeSequenceDiagramPreview(canvas, translate));
            break;
    }
    if (colorEnabled) {
