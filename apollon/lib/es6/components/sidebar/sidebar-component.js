...
class SidebarComponent extends Component {
    ...
    render() {
        if (this.props.readonly || this.props.mode === ApollonMode.Assessment)
            return null;
        return (React.createElement(Container, { id: "modeling-editor-sidebar", "data-cy": "modeling-editor-sidebar" }, this.props.view === "Modelling" /* ApollonView.Modelling */ ? (React.createElement(CreatePane, null)) : (React.createElement("label", { htmlFor: "toggleInteractiveElementsMode" },
